        ...
        <main className="flex min-h-screen flex-col items-center">
            ...
            <form onSubmit={handleSubmit} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                <div className="mb-4 flex flex-col w-500">
                    ...
                    <label htmlFor="form-title">Titulo del problema:</label>
                    <input id="form-tittle" required autoComplete="titulo" maxLength={50} size="lg" name="titulo" className="text-black" />
                ...
                <div className="flex justify-center mt-4">
                    <button className="rounded bg-sky-400 px-4 py-2" type="submit">Enviar</button>
                </div>
            </form>
        </main>
    )
